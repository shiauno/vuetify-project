  ...
  <v-container>
    <v-row>
      ...
      <v-col cols="12" md="7" class="d-flex flex-wrap">
        ...
        <v-sheet color="#89BE99" :height="200" :width="200" class="d-flex justify-center align-center rounded-lg mx-4" style="font-size: 35px;" >
        ...
        <v-sheet color="#89BE99" :height="200" :width="200" class="d-flex justify-center align-center rounded-lg mx-4" style="font-size: 30px;" >
